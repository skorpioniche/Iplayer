! function (n) {
    ...
    t.prototype = {
        ...
        toggle: function () {
            var i = n(this),
                f, e;
            if (!i.is(".disabled, :disabled")) return f = r(i), e = f.hasClass("open"), u(), e || (f.toggleClass("open"), i.focus()), !1
        },
        keydown: function (t) {
            var f, u, s, e, o, i;
    ...
    t.prototype = {
        ...
        init: function (t, i, r) {
            ...
            if (this.type = t, this.$element = n(i), this.options = this.getOptions(r), this.enabled = !0, this.options.trigger == "click") this.$element.on("click." + this.type, this.options.selector, n.proxy(this.toggle, this));
                ...
                u = this.options.trigger == "hover" ? "mouseenter" : "focus", f = this.options.trigger == "hover" ? "mouseleave" : "blur";
        ...
        show: function () {
            ...
            if (this.hasContent() && this.enabled) {
                t = this.tip(), this.setContent(), this.options.animation && t.addClass("fade"), i = typeof this.options.placement == "function" ? this.options.placement.call(this, t[0], this.$element[0]) : this.options.placement, u = /in/.test(i), t.remove().css({
                    top: 0,
                    left: 0,
                    display: "block"
                }).appendTo(u ? this.$element : document.body), n = this.getPosition(u), f = t[0].offsetWidth, e = t[0].offsetHeight;
    ...
    t.prototype = n.extend({}, n.fn.tooltip.Constructor.prototype, {
        ...
        setContent: function () {
            var n = this.tip(),
                t = this.getTitle(),
                i = this.getContent();
            n.find(".popover-title")[this.options.html ? "html" : "text"](t), n.find(".popover-content > *")[this.options.html ? "html" : "text"](i), n.removeClass("fade top bottom left right in")
        },
        hasContent: function () {
        ...
        getContent: function () {
            var i, t = this.$element,
                n = this.options;
            return i = t.attr("data-content") || (typeof n.content == "function" ? n.content.call(t[0]) : n.content)
        },
        tip: function () {
    ...
    t.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
            var o = n(document).height(),
                ...
                i;
            (typeof t != "object" && (r = u = t), typeof u == "function" && (u = t.top()), typeof r == "function" && (r = t.bottom()), i = this.unpin != null && f + this.unpin <= e.top ? !1 : r != null && e.top + this.$element.height() >= o - r ? "bottom" : u != null && f <= u ? "top" : !1, this.affixed !== i) && (this.affixed = i, this.unpin = i == "bottom" ? e.top - f : null, this.$element.removeClass(s).addClass("affix" + (i ? "-" + i : "")))
        }
    ...
    t.prototype.close = function (t) {
        ...
        return this.each(function () {
            var r = n(this),
                u = r.data("alert");
            u || r.data("alert", u = new t(this)), typeof i == "string" && u[i].call(r)
        })
    ...
    t.prototype.setState = function (n) {
        ...
        n = n + "Text", r.resetText || t.data("resetText", t[u]()), t[u](r[n] || this.options[n]), setTimeout(function () {
        ...
        show: function () {
            ...
            if (!this.transitioning) {
                if (i = this.dimension(), u = n.camelCase(["scroll", i].join("-")), t = this.$parent && this.$parent.find("> .accordion-group > .in"), t && t.length) {
                    ...
                    t.collapse("hide"), r || t.data("collapse", null)
                }
                this.$element[i](0), this.transition("addClass", n.Event("show"), "shown"), n.support.transition && this.$element[i](this.$element[0][u])
            }
        },
        hide: function () {
            var t;
    ...
    t.prototype = {
        ...
        slide: function (t, i) {
            ...
            if (this.sliding = !0, o && this.pause(), r = r.length ? r : this.$element.find(".item")[h](), !r.hasClass("active")) {
                if (n.support.transition && this.$element.hasClass("slide")) {
                    ...
                    r.addClass(t), r[0].offsetWidth, u.addClass(f), r.addClass(f);
                    this.$element.one(n.support.transition.end, function () {
                        r.removeClass([t, f].join(" ")).addClass("active"), u.removeClass(["active", f].join(" ")), s.sliding = !1, setTimeout(function () {
        ...
        return this.each(function () {
            ...
            r || f.data("carousel", r = new t(this, u)), typeof i == "number" ? r.to(i) : e ? r[e]() : u.interval && r.cycle()
        })
